            ...
            switch (journalID)
            {
                case 1:
                    journalText = "While my posting on the doors does grow morose at times, I am ever grateful I am not put watching the halls below." +
                                ...
                                "Like as hard as it is here, I am glad I am not down there. I am glad I will not end up like Ed.";
                    break;
                case 2:
                ...
                case 5:
                    journalText = "I don’t know which is more terrifying. Patrolling the cells of the fiends or being the last line of defence if they escape." +
                                  "I have done both and still cannot decide. At least hear I would have some warning before I die. For if they escape no-one is leaving here alive." +
